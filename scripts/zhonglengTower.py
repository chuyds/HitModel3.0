...
if __name__ == "__main__":
    ...
    for data in bridge.realtime():
        ...
        print(f'step:{step} temp:{temp_out}')
        ...
        u_matrix_raw.append([TT_82221, temp_in, total_gas_flow, water_flow])  # u1, u2, u3, u4
        y_matrix_raw.append(temp_out)  # y = 终冷塔A出口煤气温度
        ...
        if  step > 20 and step % predict_step == 0:
            ...
            # ===== 新增：判断并发送控制状态 =====
            if FI_33111A < 0 and FI_33111B < 0:
                control_status = 1
            else:
                control_status = 2
