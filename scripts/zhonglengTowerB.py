...
class HitModelDBClient:
    def __init__(
        ...
        model_code="final_cooler_temp_control_modelB",
        timeout=3
    ):
        self.url = url
...
if __name__ == "__main__":
    ...
    for data in bridge.realtime():
        ...
        TT_82201B = float(data["TT_82201B_AV"])  # 终冷塔A进口煤气温度
        TT_82202B = float(data["TT_82202B_AV"])  # 终冷塔A出口煤气温度
        ...
        print(f'step:{step} temp:{TT_82202B}')
        ...
        u_matrix_raw.append([TT_82221, TT_82201B, total_gas_flow, FI_33111B])  # u1, u2, u3, u4
        y_matrix_raw.append(TT_82202B)  # y = 终冷塔A出口煤气温度
        ...
        if  step > 20 and step % predict_step == 0:
            ...
            bridge.write("工大OPC.AO.HIT_11116_SP", u4_pred)
            print(f"✅k+20时刻预测流量：{u4_pred}")

            # ===== 新增：判断并发送控制状态 =====
            if FI_33111B < FI_33111A or FI_33111B < 0:
                control_status = 1
            else:
                control_status = 2
